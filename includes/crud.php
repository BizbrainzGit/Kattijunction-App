...
define('DOMAIN_URL', 'http://52.66.249.224/Kattijunction-App/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "Athidiuser";  // Change as required
    private $db_pass = "User@123";
    private $db_name = "kattijunction-app";    // Change as required
